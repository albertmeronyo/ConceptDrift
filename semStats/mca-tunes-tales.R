...
###########################
res <- read.csv('/Users/Albert/src/ConceptDrift/semStats/data/BRT_1889_08_T1.csv', header = TRUE)
res2 <- read.csv('/Users/Albert/src/ConceptDrift/semStats/data/BRT_1899_04_T.csv', header = TRUE)
...
h1 <- read.xls('/Users/Albert/src/ConceptDrift/semStats/data/1889_08_T1.xls')
h1$ID <- NULL
h1$ALTBEROEP <- NULL 
h1$STATUS <- NULL 
h1$REL <- NULL
...
# Load HISCO data and merge
h2 <- read.xls('/Users/Albert/src/ConceptDrift/semStats/data/1899_04_T.xls')
h2$ID <- NULL
h2$ALTBEROEP <- NULL 
h2$STATUS <- NULL 
h2$REL <- NULL
