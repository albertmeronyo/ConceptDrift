...
java $MEM $WEKAPATH weka.classifiers.bayes.BayesNet $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.bayes.NaiveBayes $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.bayes.NaiveBayesMultinomial $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.bayes.NaiveBayesMultinomialUpdateable $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.bayes.NaiveBayesUpdateable $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.functions.Logistic $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.functions.MultilayerPerceptron $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.functions.SGD $USE_MODEL $TEST >> $OUTPUT
echo "SGD completed."
...
java $MEM $WEKAPATH weka.classifiers.functions.SimpleLogistic $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.functions.SMO $USE_MODEL $TEST >> $OUTPUT
echo "SMO completed."
...
java $MEM $WEKAPATH weka.classifiers.functions.VotedPerceptron $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.rules.DecisionTable $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.rules.JRip $USE_MODEL $TEST >> $OUTPUT
echo "JRip completed."
echo "Starting OneR..."
echo "weka.classifiers.rules.OneR -i -o -B 6" >> $OUTPUT
java $MEM $WEKAPATH weka.classifiers.rules.OneR $INPUT $MODEL -i -o -B 6 >> $OUTPUT
java $MEM $WEKAPATH weka.classifiers.rules.OneR $USE_MODEL $TEST >> $OUTPUT
echo "OneR completed."
# echo "Starting PART..."
...
java $MEM $WEKAPATH weka.classifiers.rules.ZeroR $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.trees.DecisionStump $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.trees.HoeffdingTree $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.trees.J48 $USE_MODEL $TEST >> $OUTPUT
echo "J48 completed."
# echo "Starting LMT..."
...
java $MEM $WEKAPATH weka.classifiers.trees.RandomForest $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.trees.RandomTree $USE_MODEL $TEST >> $OUTPUT
...
java $MEM $WEKAPATH weka.classifiers.trees.REPTree $USE_MODEL $TEST >> $OUTPUT
