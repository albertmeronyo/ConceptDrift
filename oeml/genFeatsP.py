...
print args.input, args.output, args.n, args.str, args.member, args.label, args.format, args.change_definition, args.delta_tt, args.delta_fc, args.partial_tree
...
for ds in t_snapshots:
    ...
    with open(args.output + 'feats_' + ds + '.csv', 'wb') as csvfile:
        ...
        for key, children in tree_o.iteritems():
            node = key
