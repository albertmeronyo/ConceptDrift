...
for dirname, dirnames, filenames in os.walk(lovDir):
    for subdirname in dirnames:
        ...
        for x, y, versions in os.walk(os.path.join(dirname, subdirname)):
            ...
            call(["./oeml.sh", lovDir + subdirname, thisExpDir, nVersions, 1, 1, "allDrift", "T", "http://www.w3.org/2002/07/owl#Thing", "http://www.w3.org/2000/01/rdf-schema#subClassOf", "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", "http://www.w3.org/2000/01/rdf-schema#label"])
